...
4. Self-review the draft against the tells checklist and rewrite (from intent) any sentence that trips a tell.

## Workflow

1. Read the skill and the ground truth.
2. Outline the page's sections with descriptive headings.
3. Draft, keeping each section self-contained and describing-and-linking to reference pages another page owns.
