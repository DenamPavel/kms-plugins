...
3. Produce a DO-NOT-LEAK list: implementation details, internal limits, framework and library names, table and column names, API routes, secrets, and competitive framing that must stay out of user docs.
