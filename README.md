...
3. **Setting up an isolated sandbox**: credentials bound via environment/closure, stateless execution, structured `{ ok, output/error }` return, and the sandbox never throws
